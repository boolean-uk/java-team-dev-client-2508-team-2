...
const ProfilePage = () => {
  ...
  const handleSave = async () => {
    try {
      ...
      if (profile.user.id === parseInt(id)) {
        ...
        profile.user.roles.some((r) => r.name === 'ROLE_TEACHER')
      ) {
        payload.jobTitle = profile.jobTitle;
  ...
  const { firstName, lastName, phone, bio, githubUrl, jobTitle, user: userData } = profile;
        ...
        <div className="profile-card">
          <div className="profile-header-row">
            ...
            <div className="profile-header-info">
              ...
              <p className="profile-subtitle">{userData.cohort?.specialisation?.name || '—'}</p>
            </div>
            ...
            <div className="profile-right">
              {userData.student ? (
                <ProfileSection title="Training Info">
                  <ProfileField label="Role" value={userData.roles[0].name.replace('ROLE_', '')} />
                  <ProfileField
                    label="Cohort"
                  ...
                  />
                  <ProfileField label="Start date" value={userData.cohort?.startDate || '—'} />
                  <ProfileField label="End date" value={userData.cohort?.endDate || '—'} />
                </ProfileSection>
              ) : (
